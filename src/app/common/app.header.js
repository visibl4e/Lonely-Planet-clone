    ...
    <div class="image-container">
      ...
      <div class="navbar-container">
        ...
        <a href="#">
          <p>
            take<span
              ><object class="logo" data="../../img/logo.svg"></object></span
            >ride
          </p>
        </a>
  ...
  <section class="explore">
    ...
    <div class="main-arcticle">
      <div class="img">
        ...
        <p>
          For such a small country, Switzerland doesn’t lack for beautiful spots
          to visit. We’ve rounded up our favorites.
        </p>
      </div>
      <aside class="aside">
        <div class="carousel" data-carousel>
          <button class="btn button-prev" data-carousel-button>&#8656;</button>
          <button class="btn button-next" data-carousel-button>&#8658;</button>
          <ul class="slider" data-slides>
            ...
            <li class="slide" data-active>
              ...
              />
              <div class="slide-text">
                <div><a href="#" class="activity">Activities</a> <br /></div>
                <div>
                  <a href="#" class="places"
            ...
            <li class="slide" data-active>
              ...
              <div class="slide-text">
                ...
                <div>
                  <p>
                    The best hikes in Yellowstone, from wheelchair-accessible
                    boardwalk strolls to multiday backpacking trips, taking in
                    geysers, waterfalls and mountain summits.
                  </p>
                </div>
              </div>
            </li>
            <li class="slide" data-active>
              ...
              />
              <div class="slide-text">
                <div><a href="#" class="activity">Tips & Advice</a> <br /></div>
                <div>
                  <a href="#" class="places"
                ...
                <div>
                  <p>
                    Singapore is one of the world’s smallest countries, but it
                    packs a lot into a small space. Here are the must-visit
                    places.
                  </p>
                </div>
              </div>
            ...
            <li class="slide" data-active>
              ...
              />
              <div class="slide-text">
                <div><a href="#" class="activity">Road Trips</a> <br /></div>
                <div>
                  <a href="#" class="places"
                ...
                <div>
                  <p>
                    Dubrovnik is simply gorgeous, yes – which is why it draws
                    such crowds. Find the same history and charm in lesser-known
                    Šibenik.
                  </p>
                </div>
              </div>
  ...
  <section class="books">
    <div class="container">
      <div class="view-container">
        ...
        <p class="description">
          ...
          cruise, or cooking a new dish — we’re committed to inspiring you to
          experience travel in a whole new way. Lonely Planet’s collection of
          825+ travel and guidebooks is sure to inspire the traveler within.
        </p>
    ...
    <section class="social">
      ...
      <div class="review-gallery">
        ...
        <a href="https://www.instagram.com/unchartedbackpacker" target="_blank">
          <div class="picture">
            <img
        ...
        <a href="https://www.instagram.com/les_carnets_de_mel" target="_blank">
          <div class="picture">
            <img
        ...
        <a href="https://www.instagram.com/o_thessalonikios" target="_blank">
          <div class="picture">
            <img
        ...
        <a href="https://www.instagram.com/richardwhitetravels" target="_blank">
          <div class="picture">
            <img
